...
const classList = ref([])
onMounted(async () => {
  studentList.value = await axios.get(`https://schoolsapi.netserve.in/student-class?filter[class_id][eq]=${props.id}&expand=student,class,session&per-page=50`).then(r => r.data)
